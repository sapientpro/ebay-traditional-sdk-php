...
use SapientPro\EbayTraditionalSDK\Taxonomy\Types\CategoryTreeNode;
...
class CategoryTreeNodeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Taxonomy\Types\CategoryTreeNode', $this->obj);
    }
