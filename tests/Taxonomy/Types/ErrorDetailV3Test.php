...
use SapientPro\EbayTraditionalSDK\Taxonomy\Types\ErrorDetailV3;
...
class ErrorDetailV3Test extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Taxonomy\Types\ErrorDetailV3', $this->obj);
    }
