...
use SapientPro\EbayTraditionalSDK\Taxonomy\Types\ErrorParameterV3;
...
class ErrorParameterV3Test extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Taxonomy\Types\ErrorParameterV3', $this->obj);
    }
