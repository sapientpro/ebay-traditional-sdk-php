...
use SapientPro\EbayTraditionalSDK\Taxonomy\Types\AncestorReference;
...
class AncestorReferenceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Taxonomy\Types\AncestorReference', $this->obj);
    }
