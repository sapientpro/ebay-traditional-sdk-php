...
use SapientPro\EbayTraditionalSDK\HalfFinding\Types\ProductIDType;
...
class ProductIDTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\HalfFinding\Types\ProductIDType', $this->obj);
    }
