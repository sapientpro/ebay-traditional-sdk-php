...
use SapientPro\EbayTraditionalSDK\HalfFinding\Types\SortByType;
...
class SortByTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\HalfFinding\Types\SortByType', $this->obj);
    }
