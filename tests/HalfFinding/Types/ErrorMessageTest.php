...
use SapientPro\EbayTraditionalSDK\HalfFinding\Types\ErrorMessage;
...
class ErrorMessageTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\HalfFinding\Types\ErrorMessage', $this->obj);
    }
