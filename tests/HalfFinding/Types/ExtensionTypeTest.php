...
use SapientPro\EbayTraditionalSDK\HalfFinding\Types\ExtensionType;
...
class ExtensionTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\HalfFinding\Types\ExtensionType', $this->obj);
    }
