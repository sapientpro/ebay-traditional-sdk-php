...
use SapientPro\EbayTraditionalSDK\HalfFinding\Types\ErrorParameter;
...
class ErrorParameterTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\HalfFinding\Types\ErrorParameter', $this->obj);
    }
