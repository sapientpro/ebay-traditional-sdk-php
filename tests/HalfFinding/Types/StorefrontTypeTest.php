...
use SapientPro\EbayTraditionalSDK\HalfFinding\Types\StorefrontType;
...
class StorefrontTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\HalfFinding\Types\StorefrontType', $this->obj);
    }
