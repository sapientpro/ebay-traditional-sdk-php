...
use SapientPro\EbayTraditionalSDK\Tests\Mocks\Service;
...
class AttachmentTest extends TestCase
{
    ...
    public function testAttachment()
    {
        ...
        $this->assertEquals(
            ['data' => '123ABC', 'mimeType' => 'application/octet-stream'],
    ...
    public function testHttpHeadersAreCreated()
    {
        ...
        $this->assertEquals(
            'multipart/related;boundary=MIME_boundary;type="application/xop+xml";start="<request.xml@devbay.net>";start-info="text/xml"',
            $this->httpHandler->headers['Content-Type']
        );
    ...
    public function testResponseIsReturned(): void
    {
        ...
        $this->assertInstanceOf(ComplexClass::class, $response);
    ...
    protected function setUp(): void
    {
        ...
        $this->requestXml = rtrim(file_get_contents(__DIR__.'/../Mocks/AttachmentRequestResponse.content'));
    }
}
