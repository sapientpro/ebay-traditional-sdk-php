...
class ConstructTest extends TestCase
{
    public function testSettingPropertiesViaCtor()
    {
        ...
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Types\RepeatableType', $obj->strings);

        $this->assertEquals(2, count($obj->integers));
        $this->assertEquals(111, $obj->integers[0]);
        $this->assertEquals(222, $obj->integers[1]);
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Types\RepeatableType', $obj->integers);

        $this->assertEquals(543.21, $obj->AmountClass->value);
        $this->assertEquals('one', $obj->AmountClass->AttributeOne);
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Tests\Mocks\AmountClass', $obj->AmountClass);
        ...
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Tests\Mocks\SimpleClass', $obj->SimpleClass);
        ...
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Types\RepeatableType', $obj->simpleClasses);
        ...
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Types\RepeatableType', $obj->anyTypes);
    }

    public function testSettingInvalidPropertyViaCtor()
    {
        $this->expectException('\SapientPro\EbayTraditionalSDK\Exceptions\UnknownPropertyException', 'Unknown property bar');
    ...
    {
        $this->expectException('\SapientPro\EbayTraditionalSDK\Exceptions\InvalidPropertyTypeException', 'Invalid property type provided for string. Expected string but got integer');
