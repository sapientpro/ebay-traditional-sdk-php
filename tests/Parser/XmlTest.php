...
namespace SapientPro\EbayTraditionalSDK\Parser\Test;
...
class XmlTest extends TestCase
{
    ...
    {
        $xmlParser = new XmlParser('\SapientPro\EbayTraditionalSDK\Tests\Mocks\ComplexClass');
        $xml = file_get_contents(__DIR__.'/../Mocks/Response.xml');
        $xml = preg_replace('/[\n\r]/', '', $xml);
        $xml = preg_replace('/>\s+/', '>', $xml);
        $obj = $xmlParser->parse($xml);

        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Tests\Mocks\ComplexClass', $obj);
        ...
        $this->assertEquals('bar', $obj->strings[1]);
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Tests\Mocks\SimpleClass', $obj->simpleClasses[0]);
        $this->assertEquals(888, $obj->simpleClasses[0]->integer);
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Tests\Mocks\SimpleClass', $obj->simpleClasses[1]);
