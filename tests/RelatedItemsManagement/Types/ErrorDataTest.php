...
use SapientPro\EbayTraditionalSDK\RelatedItemsManagement\Types\ErrorData;
...
class ErrorDataTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\RelatedItemsManagement\Types\ErrorData', $this->obj);
    }
