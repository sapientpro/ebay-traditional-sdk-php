...
use SapientPro\EbayTraditionalSDK\Inventory\Types\TimeDuration;
...
class TimeDurationTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Inventory\Types\TimeDuration', $this->obj);
    }
