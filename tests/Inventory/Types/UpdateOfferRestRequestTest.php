...
class UpdateOfferRestRequestTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Inventory\Types\UpdateOfferRestRequest', $this->obj);
    }

    public function testExtendsEbayOfferDetailsWithId()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Inventory\Types\EbayOfferDetailsWithId', $this->obj);
    }
