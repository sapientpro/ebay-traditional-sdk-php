...
use SapientPro\EbayTraditionalSDK\Inventory\Types\GeoCoordinates;
...
class GeoCoordinatesTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Inventory\Types\GeoCoordinates', $this->obj);
    }
