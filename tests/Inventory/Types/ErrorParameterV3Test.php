...
use SapientPro\EbayTraditionalSDK\Inventory\Types\ErrorParameterV3;
...
class ErrorParameterV3Test extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Inventory\Types\ErrorParameterV3', $this->obj);
    }
