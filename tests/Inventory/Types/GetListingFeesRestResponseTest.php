...
class GetListingFeesRestResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Inventory\Types\GetListingFeesRestResponse', $this->obj);
    }

    public function testExtendsFeesSummaryResponse()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Inventory\Types\FeesSummaryResponse', $this->obj);
    }
