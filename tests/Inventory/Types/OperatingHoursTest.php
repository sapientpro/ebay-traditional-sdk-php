...
use SapientPro\EbayTraditionalSDK\Inventory\Types\OperatingHours;
...
class OperatingHoursTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Inventory\Types\OperatingHours', $this->obj);
    }
