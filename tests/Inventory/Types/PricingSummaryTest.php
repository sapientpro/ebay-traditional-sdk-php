...
use SapientPro\EbayTraditionalSDK\Inventory\Types\PricingSummary;
...
class PricingSummaryTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Inventory\Types\PricingSummary', $this->obj);
    }
