...
use SapientPro\EbayTraditionalSDK\Inventory\Types\ListingDetails;
...
class ListingDetailsTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Inventory\Types\ListingDetails', $this->obj);
    }
