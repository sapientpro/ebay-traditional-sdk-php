...
use SapientPro\EbayTraditionalSDK\Inventory\Types\MigrateListing;
...
class MigrateListingTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Inventory\Types\MigrateListing', $this->obj);
    }
