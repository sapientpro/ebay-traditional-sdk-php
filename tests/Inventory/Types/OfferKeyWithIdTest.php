...
use SapientPro\EbayTraditionalSDK\Inventory\Types\OfferKeyWithId;
...
class OfferKeyWithIdTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Inventory\Types\OfferKeyWithId', $this->obj);
    }
