...
use SapientPro\EbayTraditionalSDK\Inventory\Types\ErrorDetailV3;
...
class ErrorDetailV3Test extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Inventory\Types\ErrorDetailV3', $this->obj);
    }
