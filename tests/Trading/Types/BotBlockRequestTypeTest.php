...
use SapientPro\EbayTraditionalSDK\Trading\Types\BotBlockRequestType;
...
class BotBlockRequestTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\BotBlockRequestType', $this->obj);
    }
