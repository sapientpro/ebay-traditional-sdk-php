...
use SapientPro\EbayTraditionalSDK\Trading\Types\RefundArrayType;
...
class RefundArrayTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\RefundArrayType', $this->obj);
    }
