...
use SapientPro\EbayTraditionalSDK\Trading\Types\FaultDetailsType;
...
class FaultDetailsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\FaultDetailsType', $this->obj);
    }
