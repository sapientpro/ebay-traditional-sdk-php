...
use SapientPro\EbayTraditionalSDK\Trading\Types\MyMessagesMessageType;
...
class MyMessagesMessageTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\MyMessagesMessageType', $this->obj);
    }
