...
use SapientPro\EbayTraditionalSDK\Trading\Types\ItemTransactionIDType;
...
class ItemTransactionIDTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\ItemTransactionIDType', $this->obj);
    }
