...
use SapientPro\EbayTraditionalSDK\Trading\Types\ListingTipType;
...
class ListingTipTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\ListingTipType', $this->obj);
    }
