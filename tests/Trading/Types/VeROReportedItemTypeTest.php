...
use SapientPro\EbayTraditionalSDK\Trading\Types\VeROReportedItemType;
...
class VeROReportedItemTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\VeROReportedItemType', $this->obj);
    }
