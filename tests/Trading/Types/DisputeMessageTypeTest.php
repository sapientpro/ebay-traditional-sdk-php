...
use SapientPro\EbayTraditionalSDK\Trading\Types\DisputeMessageType;
...
class DisputeMessageTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\DisputeMessageType', $this->obj);
    }
