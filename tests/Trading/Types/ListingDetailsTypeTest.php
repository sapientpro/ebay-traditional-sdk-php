...
use SapientPro\EbayTraditionalSDK\Trading\Types\ListingDetailsType;
...
class ListingDetailsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\ListingDetailsType', $this->obj);
    }
