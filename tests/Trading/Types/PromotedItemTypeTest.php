...
use SapientPro\EbayTraditionalSDK\Trading\Types\PromotedItemType;
...
class PromotedItemTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\PromotedItemType', $this->obj);
    }
