...
use SapientPro\EbayTraditionalSDK\Trading\Types\CrossPromotionsType;
...
class CrossPromotionsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\CrossPromotionsType', $this->obj);
    }
