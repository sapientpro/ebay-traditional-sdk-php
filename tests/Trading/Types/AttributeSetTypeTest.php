...
use SapientPro\EbayTraditionalSDK\Trading\Types\AttributeSetType;
...
class AttributeSetTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\AttributeSetType', $this->obj);
    }
