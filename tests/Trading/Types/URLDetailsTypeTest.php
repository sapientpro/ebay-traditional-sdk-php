...
use SapientPro\EbayTraditionalSDK\Trading\Types\URLDetailsType;
...
class URLDetailsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\URLDetailsType', $this->obj);
    }
