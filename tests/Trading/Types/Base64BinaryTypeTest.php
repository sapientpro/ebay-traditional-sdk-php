...
use SapientPro\EbayTraditionalSDK\Trading\Types\Base64BinaryType;
...
class Base64BinaryTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\Base64BinaryType', $this->obj);
    }
