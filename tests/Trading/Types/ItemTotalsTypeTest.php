...
use SapientPro\EbayTraditionalSDK\Trading\Types\ItemTotalsType;
...
class ItemTotalsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\ItemTotalsType', $this->obj);
    }
