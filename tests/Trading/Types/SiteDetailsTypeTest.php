...
use SapientPro\EbayTraditionalSDK\Trading\Types\SiteDetailsType;
...
class SiteDetailsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\SiteDetailsType', $this->obj);
    }
