...
use SapientPro\EbayTraditionalSDK\Trading\Types\MyMessagesFolderType;
...
class MyMessagesFolderTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\MyMessagesFolderType', $this->obj);
    }
