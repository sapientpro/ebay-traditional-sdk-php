...
use SapientPro\EbayTraditionalSDK\Trading\Types\PickupOptionsType;
...
class PickupOptionsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\PickupOptionsType', $this->obj);
    }
