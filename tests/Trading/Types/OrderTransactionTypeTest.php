...
use SapientPro\EbayTraditionalSDK\Trading\Types\OrderTransactionType;
...
class OrderTransactionTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\OrderTransactionType', $this->obj);
    }
