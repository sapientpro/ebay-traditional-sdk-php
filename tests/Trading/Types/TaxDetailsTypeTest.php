...
use SapientPro\EbayTraditionalSDK\Trading\Types\TaxDetailsType;
...
class TaxDetailsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\TaxDetailsType', $this->obj);
    }
