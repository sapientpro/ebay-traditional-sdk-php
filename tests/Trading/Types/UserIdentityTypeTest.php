...
use SapientPro\EbayTraditionalSDK\Trading\Types\UserIdentityType;
...
class UserIdentityTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\UserIdentityType', $this->obj);
    }
