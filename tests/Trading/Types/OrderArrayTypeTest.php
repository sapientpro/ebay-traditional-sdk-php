...
use SapientPro\EbayTraditionalSDK\Trading\Types\OrderArrayType;
...
class OrderArrayTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\OrderArrayType', $this->obj);
    }
