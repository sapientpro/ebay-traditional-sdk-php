...
use SapientPro\EbayTraditionalSDK\Trading\Types\InventoryStatusType;
...
class InventoryStatusTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\InventoryStatusType', $this->obj);
    }
