...
use SapientPro\EbayTraditionalSDK\Trading\Types\ListingTipArrayType;
...
class ListingTipArrayTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\ListingTipArrayType', $this->obj);
    }
