...
use SapientPro\EbayTraditionalSDK\Trading\Types\TokenStatusType;
...
class TokenStatusTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\TokenStatusType', $this->obj);
    }
