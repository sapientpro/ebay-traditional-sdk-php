...
use SapientPro\EbayTraditionalSDK\Trading\Types\PaymentHoldDetailType;
...
class PaymentHoldDetailTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\PaymentHoldDetailType', $this->obj);
    }
