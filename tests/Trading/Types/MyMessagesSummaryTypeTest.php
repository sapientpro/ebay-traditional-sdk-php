...
use SapientPro\EbayTraditionalSDK\Trading\Types\MyMessagesSummaryType;
...
class MyMessagesSummaryTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\MyMessagesSummaryType', $this->obj);
    }
