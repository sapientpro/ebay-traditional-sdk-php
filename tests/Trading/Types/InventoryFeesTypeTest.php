...
use SapientPro\EbayTraditionalSDK\Trading\Types\InventoryFeesType;
...
class InventoryFeesTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\InventoryFeesType', $this->obj);
    }
