...
use SapientPro\EbayTraditionalSDK\Trading\Types\AccountEntryType;
...
class AccountEntryTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\AccountEntryType', $this->obj);
    }
