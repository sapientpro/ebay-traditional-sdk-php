...
use SapientPro\EbayTraditionalSDK\Trading\Types\ThemeGroupType;
...
class ThemeGroupTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\ThemeGroupType', $this->obj);
    }
