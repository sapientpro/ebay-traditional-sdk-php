...
use SapientPro\EbayTraditionalSDK\Trading\Types\AttributeSetArrayType;
...
class AttributeSetArrayTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\AttributeSetArrayType', $this->obj);
    }
