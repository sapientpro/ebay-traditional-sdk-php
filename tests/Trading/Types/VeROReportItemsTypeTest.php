...
use SapientPro\EbayTraditionalSDK\Trading\Types\VeROReportItemsType;
...
class VeROReportItemsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\VeROReportItemsType', $this->obj);
    }
