...
use SapientPro\EbayTraditionalSDK\Trading\Types\ListingTipMessageType;
...
class ListingTipMessageTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\ListingTipMessageType', $this->obj);
    }
