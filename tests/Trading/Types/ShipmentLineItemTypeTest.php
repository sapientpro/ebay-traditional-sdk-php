...
use SapientPro\EbayTraditionalSDK\Trading\Types\ShipmentLineItemType;
...
class ShipmentLineItemTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\ShipmentLineItemType', $this->obj);
    }
