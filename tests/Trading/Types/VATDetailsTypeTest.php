...
use SapientPro\EbayTraditionalSDK\Trading\Types\VATDetailsType;
...
class VATDetailsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Trading\Types\VATDetailsType', $this->obj);
    }
