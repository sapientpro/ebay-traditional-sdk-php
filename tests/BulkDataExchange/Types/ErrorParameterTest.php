...
use SapientPro\EbayTraditionalSDK\BulkDataExchange\Types\ErrorParameter;
...
class ErrorParameterTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\BulkDataExchange\Types\ErrorParameter', $this->obj);
    }
