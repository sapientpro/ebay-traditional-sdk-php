...
use SapientPro\EbayTraditionalSDK\BulkDataExchange\Types\ErrorData;
...
class ErrorDataTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\BulkDataExchange\Types\ErrorData', $this->obj);
    }
