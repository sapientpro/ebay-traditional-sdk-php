...
use SapientPro\EbayTraditionalSDK\BulkDataExchange\Types\SiteFilter;
...
class SiteFilterTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\BulkDataExchange\Types\SiteFilter', $this->obj);
    }
