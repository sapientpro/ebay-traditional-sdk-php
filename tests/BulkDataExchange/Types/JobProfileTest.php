...
use SapientPro\EbayTraditionalSDK\BulkDataExchange\Types\JobProfile;
...
class JobProfileTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\BulkDataExchange\Types\JobProfile', $this->obj);
    }
