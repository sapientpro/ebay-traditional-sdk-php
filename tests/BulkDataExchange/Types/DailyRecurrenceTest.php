...
use SapientPro\EbayTraditionalSDK\BulkDataExchange\Types\DailyRecurrence;
...
class DailyRecurrenceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\BulkDataExchange\Types\DailyRecurrence', $this->obj);
    }
