...
class ProcessReturnRequestRestResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ProcessReturnRequestRestResponse', $this->obj);
    }

    public function testExtendsDecideReturnResponse()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\DecideReturnResponse', $this->obj);
    }
