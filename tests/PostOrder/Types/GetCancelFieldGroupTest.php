...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\GetCancelFieldGroup;
...
class GetCancelFieldGroupTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\GetCancelFieldGroup', $this->obj);
    }
