...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\CancelDetail;
...
class CancelDetailTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\CancelDetail', $this->obj);
    }
