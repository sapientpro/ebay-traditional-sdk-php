...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\ErrorParameter;
...
class ErrorParameterTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ErrorParameter', $this->obj);
    }
