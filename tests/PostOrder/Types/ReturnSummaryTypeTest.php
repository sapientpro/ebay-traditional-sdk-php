...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnSummaryType;
...
class ReturnSummaryTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnSummaryType', $this->obj);
    }
