...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnCloseInfoType;
...
class ReturnCloseInfoTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnCloseInfoType', $this->obj);
    }
