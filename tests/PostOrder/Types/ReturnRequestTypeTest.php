...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnRequestType;
...
class ReturnRequestTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnRequestType', $this->obj);
    }
