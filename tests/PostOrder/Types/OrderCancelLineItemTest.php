...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\OrderCancelLineItem;
...
class OrderCancelLineItemTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\OrderCancelLineItem', $this->obj);
    }
