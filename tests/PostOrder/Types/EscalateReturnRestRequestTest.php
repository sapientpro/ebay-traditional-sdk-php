...
class EscalateReturnRestRequestTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\EscalateReturnRestRequest', $this->obj);
    }

    public function testExtendsEscalateRequest()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\EscalateRequest', $this->obj);
    }
