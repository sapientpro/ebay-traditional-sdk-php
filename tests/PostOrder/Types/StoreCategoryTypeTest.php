...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\StoreCategoryType;
...
class StoreCategoryTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\StoreCategoryType', $this->obj);
    }
