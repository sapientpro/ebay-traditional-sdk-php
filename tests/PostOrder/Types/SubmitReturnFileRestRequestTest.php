...
class SubmitReturnFileRestRequestTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\SubmitReturnFileRestRequest', $this->obj);
    }

    public function testExtendsSubmitFileRequest()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\SubmitFileRequest', $this->obj);
    }
