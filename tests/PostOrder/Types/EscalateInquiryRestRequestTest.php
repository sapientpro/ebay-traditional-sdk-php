...
class EscalateInquiryRestRequestTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\EscalateInquiryRestRequest', $this->obj);
    }

    public function testExtendsEscalateInquiryRequest()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\EscalateInquiryRequest', $this->obj);
    }
