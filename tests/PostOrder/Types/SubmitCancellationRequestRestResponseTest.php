...
class SubmitCancellationRequestRestResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\SubmitCancellationRequestRestResponse', $this->obj);
    }

    public function testExtendsCreateCancelResponse()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\CreateCancelResponse', $this->obj);
    }
