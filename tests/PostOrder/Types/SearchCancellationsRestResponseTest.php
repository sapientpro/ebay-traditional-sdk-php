...
class SearchCancellationsRestResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\SearchCancellationsRestResponse', $this->obj);
    }

    public function testExtendsFindCancelResponse()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\FindCancelResponse', $this->obj);
    }
