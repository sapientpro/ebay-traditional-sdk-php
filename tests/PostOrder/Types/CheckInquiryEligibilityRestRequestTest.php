...
class CheckInquiryEligibilityRestRequestTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\CheckInquiryEligibilityRestRequest', $this->obj);
    }

    public function testExtendsCheckInquiryEligibilityRequest()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\CheckInquiryEligibilityRequest', $this->obj);
    }
