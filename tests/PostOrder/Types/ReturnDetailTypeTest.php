...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnDetailType;
...
class ReturnDetailTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnDetailType', $this->obj);
    }
