...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnAddress;
...
class ReturnAddressTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnAddress', $this->obj);
    }
