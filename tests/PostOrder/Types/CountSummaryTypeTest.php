...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\CountSummaryType;
...
class CountSummaryTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\CountSummaryType', $this->obj);
    }
