...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\ShipmentType;
...
class ShipmentTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ShipmentType', $this->obj);
    }
