...
class CloseInquiryRestRequestTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\CloseInquiryRestRequest', $this->obj);
    }

    public function testExtendsBuyerCloseInquiryRequest()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\BuyerCloseInquiryRequest', $this->obj);
    }
