...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\ListDataType;
...
class ListDataTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ListDataType', $this->obj);
    }
