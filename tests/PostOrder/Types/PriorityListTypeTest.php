...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\PriorityListType;
...
class PriorityListTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\PriorityListType', $this->obj);
    }
