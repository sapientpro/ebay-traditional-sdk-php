...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\ErrorParameterV3;
...
class ErrorParameterV3Test extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ErrorParameterV3', $this->obj);
    }
