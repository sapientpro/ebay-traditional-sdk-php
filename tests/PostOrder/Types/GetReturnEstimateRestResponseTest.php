...
class GetReturnEstimateRestResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\GetReturnEstimateRestResponse', $this->obj);
    }

    public function testExtendsGetEstimateResponse()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\GetEstimateResponse', $this->obj);
    }
