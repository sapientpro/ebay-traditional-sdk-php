...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnFileType;
...
class ReturnFileTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnFileType', $this->obj);
    }
