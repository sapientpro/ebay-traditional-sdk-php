...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\PaginationOutput;
...
class PaginationOutputTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\PaginationOutput', $this->obj);
    }
