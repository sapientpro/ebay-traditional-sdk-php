...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\ErrorDetailV3;
...
class ErrorDetailV3Test extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ErrorDetailV3', $this->obj);
    }
