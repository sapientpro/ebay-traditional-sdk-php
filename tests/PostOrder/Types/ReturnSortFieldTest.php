...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnSortField;
...
class ReturnSortFieldTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ReturnSortField', $this->obj);
    }
