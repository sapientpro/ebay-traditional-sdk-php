...
class CreateCustomListRestResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\CreateCustomListRestResponse', $this->obj);
    }

    public function testExtendsCreateCustomListResponse()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\CreateCustomListResponse', $this->obj);
    }
