...
class AppealCaseDecisionRestRequestTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\AppealCaseDecisionRestRequest', $this->obj);
    }

    public function testExtendsAppealRequest()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\AppealRequest', $this->obj);
    }
