...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\CustomListType;
...
class CustomListTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\CustomListType', $this->obj);
    }
