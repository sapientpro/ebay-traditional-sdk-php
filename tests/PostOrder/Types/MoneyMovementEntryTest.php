...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\MoneyMovementEntry;
...
class MoneyMovementEntryTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\MoneyMovementEntry', $this->obj);
    }
