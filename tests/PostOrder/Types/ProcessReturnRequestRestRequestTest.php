...
class ProcessReturnRequestRestRequestTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\ProcessReturnRequestRestRequest', $this->obj);
    }

    public function testExtendsDecideReturnRequest()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\DecideReturnRequest', $this->obj);
    }
