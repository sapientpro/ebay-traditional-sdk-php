...
class CancelReturnRequestRestRequestTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\CancelReturnRequestRestRequest', $this->obj);
    }

    public function testExtendsCloseReturnRequest()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\CloseReturnRequest', $this->obj);
    }
