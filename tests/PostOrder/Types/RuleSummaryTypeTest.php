...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\RuleSummaryType;
...
class RuleSummaryTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\RuleSummaryType', $this->obj);
    }
