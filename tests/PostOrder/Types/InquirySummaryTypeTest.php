...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\InquirySummaryType;
...
class InquirySummaryTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\InquirySummaryType', $this->obj);
    }
