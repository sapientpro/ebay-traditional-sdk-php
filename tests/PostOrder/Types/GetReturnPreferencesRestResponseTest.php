...
class GetReturnPreferencesRestResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\GetReturnPreferencesRestResponse', $this->obj);
    }

    public function testExtendsGetSellerReturnPreferenceResponse()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\GetSellerReturnPreferenceResponse', $this->obj);
    }
