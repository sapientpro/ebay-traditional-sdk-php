...
use SapientPro\EbayTraditionalSDK\PostOrder\Types\AppealDetails;
...
class AppealDetailsTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\PostOrder\Types\AppealDetails', $this->obj);
    }
