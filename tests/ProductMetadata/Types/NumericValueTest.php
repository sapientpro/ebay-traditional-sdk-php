...
use SapientPro\EbayTraditionalSDK\ProductMetadata\Types\NumericValue;
...
class NumericValueTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ProductMetadata\Types\NumericValue', $this->obj);
    }
