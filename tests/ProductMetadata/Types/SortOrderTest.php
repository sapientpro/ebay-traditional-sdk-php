...
use SapientPro\EbayTraditionalSDK\ProductMetadata\Types\SortOrder;
...
class SortOrderTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ProductMetadata\Types\SortOrder', $this->obj);
    }
