...
use SapientPro\EbayTraditionalSDK\ProductMetadata\Types\ErrorMessage;
...
class ErrorMessageTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ProductMetadata\Types\ErrorMessage', $this->obj);
    }
