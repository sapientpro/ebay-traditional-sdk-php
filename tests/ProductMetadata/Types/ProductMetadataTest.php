...
use SapientPro\EbayTraditionalSDK\ProductMetadata\Types\ProductMetadata;
...
class ProductMetadataTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ProductMetadata\Types\ProductMetadata', $this->obj);
    }
