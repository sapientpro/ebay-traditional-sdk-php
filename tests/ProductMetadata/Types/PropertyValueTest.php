...
use SapientPro\EbayTraditionalSDK\ProductMetadata\Types\PropertyValue;
...
class PropertyValueTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ProductMetadata\Types\PropertyValue', $this->obj);
    }
