...
use SapientPro\EbayTraditionalSDK\ProductMetadata\Types\ExtensionType;
...
class ExtensionTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ProductMetadata\Types\ExtensionType', $this->obj);
    }
