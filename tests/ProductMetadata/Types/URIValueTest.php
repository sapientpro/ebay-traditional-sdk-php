...
use SapientPro\EbayTraditionalSDK\ProductMetadata\Types\URIValue;
...
class URIValueTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ProductMetadata\Types\URIValue', $this->obj);
    }
