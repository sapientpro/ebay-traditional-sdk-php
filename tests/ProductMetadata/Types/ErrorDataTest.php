...
use SapientPro\EbayTraditionalSDK\ProductMetadata\Types\ErrorData;
...
class ErrorDataTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ProductMetadata\Types\ErrorData', $this->obj);
    }
