...
use SapientPro\EbayTraditionalSDK\ProductMetadata\Types\ErrorParameter;
...
class ErrorParameterTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ProductMetadata\Types\ErrorParameter', $this->obj);
    }
