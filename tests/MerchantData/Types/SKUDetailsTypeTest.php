...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\SKUDetailsType;
...
class SKUDetailsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\SKUDetailsType', $this->obj);
    }
