...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\UnitInfoType;
...
class UnitInfoTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\UnitInfoType', $this->obj);
    }
