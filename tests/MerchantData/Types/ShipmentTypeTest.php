...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\ShipmentType;
...
class ShipmentTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\ShipmentType', $this->obj);
    }
