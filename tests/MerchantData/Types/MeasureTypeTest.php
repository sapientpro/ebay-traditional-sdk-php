...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\MeasureType;
...
class MeasureTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\MeasureType', $this->obj);
    }
