...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\OrderDetailsType;
...
class OrderDetailsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\OrderDetailsType', $this->obj);
    }
