...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\PickupOptionsType;
...
class PickupOptionsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\PickupOptionsType', $this->obj);
    }
