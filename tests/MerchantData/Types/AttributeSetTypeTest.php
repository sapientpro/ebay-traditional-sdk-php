...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\AttributeSetType;
...
class AttributeSetTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\AttributeSetType', $this->obj);
    }
