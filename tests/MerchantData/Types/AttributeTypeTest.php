...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\AttributeType;
...
class AttributeTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\AttributeType', $this->obj);
    }
