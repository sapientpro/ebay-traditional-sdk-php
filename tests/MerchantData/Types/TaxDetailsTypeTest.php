...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\TaxDetailsType;
...
class TaxDetailsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\TaxDetailsType', $this->obj);
    }
