...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\OrderType;
...
class OrderTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\OrderType', $this->obj);
    }
