...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\OrderArrayType;
...
class OrderArrayTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\OrderArrayType', $this->obj);
    }
