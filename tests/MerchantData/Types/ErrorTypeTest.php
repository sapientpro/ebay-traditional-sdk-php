...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\ErrorType;
...
class ErrorTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\ErrorType', $this->obj);
    }
