...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\MetadataType;
...
class MetadataTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\MetadataType', $this->obj);
    }
