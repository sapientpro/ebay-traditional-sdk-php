...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\UserIdentityType;
...
class UserIdentityTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\UserIdentityType', $this->obj);
    }
