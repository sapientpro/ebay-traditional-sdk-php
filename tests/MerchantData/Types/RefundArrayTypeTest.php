...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\RefundArrayType;
...
class RefundArrayTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\RefundArrayType', $this->obj);
    }
