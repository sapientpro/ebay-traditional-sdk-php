...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\VATDetailsType;
...
class VATDetailsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\VATDetailsType', $this->obj);
    }
