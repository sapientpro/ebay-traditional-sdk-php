...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\DistanceType;
...
class DistanceTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\DistanceType', $this->obj);
    }
