...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\PromotedItemType;
...
class PromotedItemTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\PromotedItemType', $this->obj);
    }
