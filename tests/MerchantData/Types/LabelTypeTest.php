...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\LabelType;
...
class LabelTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\LabelType', $this->obj);
    }
