...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\StorefrontType;
...
class StorefrontTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\StorefrontType', $this->obj);
    }
