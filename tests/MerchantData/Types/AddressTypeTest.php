...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\AddressType;
...
class AddressTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\AddressType', $this->obj);
    }
