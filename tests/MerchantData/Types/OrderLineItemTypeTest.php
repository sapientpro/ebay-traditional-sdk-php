...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\OrderLineItemType;
...
class OrderLineItemTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\OrderLineItemType', $this->obj);
    }
