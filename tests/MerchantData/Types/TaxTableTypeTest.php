...
use SapientPro\EbayTraditionalSDK\MerchantData\Types\TaxTableType;
...
class TaxTableTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\MerchantData\Types\TaxTableType', $this->obj);
    }
