...
use SapientPro\EbayTraditionalSDK\Order\Types\PaymentMethodBrand;
...
class PaymentMethodBrandTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Order\Types\PaymentMethodBrand', $this->obj);
    }
