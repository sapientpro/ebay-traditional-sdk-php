...
use SapientPro\EbayTraditionalSDK\Order\Types\ErrorParameterV3;
...
class ErrorParameterV3Test extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Order\Types\ErrorParameterV3', $this->obj);
    }
