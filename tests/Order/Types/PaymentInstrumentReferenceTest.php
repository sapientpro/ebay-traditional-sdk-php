...
use SapientPro\EbayTraditionalSDK\Order\Types\PaymentInstrumentReference;
...
class PaymentInstrumentReferenceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Order\Types\PaymentInstrumentReference', $this->obj);
    }
