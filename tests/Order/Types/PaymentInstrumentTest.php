...
use SapientPro\EbayTraditionalSDK\Order\Types\PaymentInstrument;
...
class PaymentInstrumentTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Order\Types\PaymentInstrument', $this->obj);
    }
