...
use SapientPro\EbayTraditionalSDK\Order\Types\ShippingFulfillment;
...
class ShippingFulfillmentTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Order\Types\ShippingFulfillment', $this->obj);
    }
