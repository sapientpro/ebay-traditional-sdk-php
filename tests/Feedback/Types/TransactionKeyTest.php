...
use SapientPro\EbayTraditionalSDK\Feedback\Types\TransactionKey;
...
class TransactionKeyTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Feedback\Types\TransactionKey', $this->obj);
    }
