...
use SapientPro\EbayTraditionalSDK\ResolutionCaseManagement\Types\ItemType;
...
class ItemTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ResolutionCaseManagement\Types\ItemType', $this->obj);
    }
