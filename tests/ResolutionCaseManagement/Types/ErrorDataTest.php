...
use SapientPro\EbayTraditionalSDK\ResolutionCaseManagement\Types\ErrorData;
...
class ErrorDataTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ResolutionCaseManagement\Types\ErrorData', $this->obj);
    }
