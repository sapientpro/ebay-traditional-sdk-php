...
class GetListingsInSpecificPromotionRestResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Marketing\Types\GetListingsInSpecificPromotionRestResponse', $this->obj);
    }

    public function testExtendsItemsPagedCollection()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Marketing\Types\ItemsPagedCollection', $this->obj);
    }
