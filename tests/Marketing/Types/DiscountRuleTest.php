...
use SapientPro\EbayTraditionalSDK\Marketing\Types\DiscountRule;
...
class DiscountRuleTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Marketing\Types\DiscountRule', $this->obj);
    }
