...
use SapientPro\EbayTraditionalSDK\Account\Types\ErrorParameterV3;
...
class ErrorParameterV3Test extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Account\Types\ErrorParameterV3', $this->obj);
    }
