...
class GetShippingRateTablesRestResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Account\Types\GetShippingRateTablesRestResponse', $this->obj);
    }

    public function testExtendsRateTableResponse()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Account\Types\RateTableResponse', $this->obj);
    }
