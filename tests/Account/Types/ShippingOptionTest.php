...
use SapientPro\EbayTraditionalSDK\Account\Types\ShippingOption;
...
class ShippingOptionTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Account\Types\ShippingOption', $this->obj);
    }
