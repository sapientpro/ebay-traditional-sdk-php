...
use SapientPro\EbayTraditionalSDK\Account\Types\InventorySnapshot;
...
class InventorySnapshotTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Account\Types\InventorySnapshot', $this->obj);
    }
