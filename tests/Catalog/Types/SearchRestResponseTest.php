...
class SearchRestResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Catalog\Types\SearchRestResponse', $this->obj);
    }

    public function testExtendsProductSearchResponse()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Catalog\Types\ProductSearchResponse', $this->obj);
    }
