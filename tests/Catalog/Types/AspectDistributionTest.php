...
use SapientPro\EbayTraditionalSDK\Catalog\Types\AspectDistribution;
...
class AspectDistributionTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Catalog\Types\AspectDistribution', $this->obj);
    }
