...
use SapientPro\EbayTraditionalSDK\Catalog\Types\CorrectionAspectValue;
...
class CorrectionAspectValueTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Catalog\Types\CorrectionAspectValue', $this->obj);
    }
