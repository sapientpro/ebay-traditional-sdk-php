...
use SapientPro\EbayTraditionalSDK\Catalog\Types\ProductSummary;
...
class ProductSummaryTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Catalog\Types\ProductSummary', $this->obj);
    }
