...
class GetProductMetadataForCategoriesRestResponseTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Catalog\Types\GetProductMetadataForCategoriesRestResponse', $this->obj);
    }

    public function testExtendsProductMetadataForCategories()
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Catalog\Types\ProductMetadataForCategories', $this->obj);
    }
