...
use SapientPro\EbayTraditionalSDK\Catalog\Types\ProcessResolution;
...
class ProcessResolutionTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Catalog\Types\ProcessResolution', $this->obj);
    }
