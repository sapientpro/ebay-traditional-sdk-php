...
use SapientPro\EbayTraditionalSDK\Browse\Types\ItemReturnTerms;
...
class ItemReturnTermsTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Browse\Types\ItemReturnTerms', $this->obj);
    }
