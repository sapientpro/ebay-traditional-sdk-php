...
use SapientPro\EbayTraditionalSDK\Browse\Types\ShipToLocations;
...
class ShipToLocationsTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Browse\Types\ShipToLocations', $this->obj);
    }
