...
use SapientPro\EbayTraditionalSDK\Browse\Types\CategoryDistribution;
...
class CategoryDistributionTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Browse\Types\CategoryDistribution', $this->obj);
    }
