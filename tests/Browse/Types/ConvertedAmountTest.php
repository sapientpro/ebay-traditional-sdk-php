...
use SapientPro\EbayTraditionalSDK\Browse\Types\ConvertedAmount;
...
class ConvertedAmountTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Browse\Types\ConvertedAmount', $this->obj);
    }
