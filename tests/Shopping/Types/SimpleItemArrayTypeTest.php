...
use SapientPro\EbayTraditionalSDK\Shopping\Types\SimpleItemArrayType;
...
class SimpleItemArrayTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Shopping\Types\SimpleItemArrayType', $this->obj);
    }
