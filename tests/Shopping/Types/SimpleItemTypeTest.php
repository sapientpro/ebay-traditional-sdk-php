...
use SapientPro\EbayTraditionalSDK\Shopping\Types\SimpleItemType;
...
class SimpleItemTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Shopping\Types\SimpleItemType', $this->obj);
    }
