...
use SapientPro\EbayTraditionalSDK\Shopping\Types\VATDetailsType;
...
class VATDetailsTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Shopping\Types\VATDetailsType', $this->obj);
    }
