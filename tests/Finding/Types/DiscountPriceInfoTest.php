...
use SapientPro\EbayTraditionalSDK\Finding\Types\DiscountPriceInfo;
...
class DiscountPriceInfoTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Finding\Types\DiscountPriceInfo', $this->obj);
    }
