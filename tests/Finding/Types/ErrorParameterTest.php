...
use SapientPro\EbayTraditionalSDK\Finding\Types\ErrorParameter;
...
class ErrorParameterTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Finding\Types\ErrorParameter', $this->obj);
    }
