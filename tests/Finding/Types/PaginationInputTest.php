...
use SapientPro\EbayTraditionalSDK\Finding\Types\PaginationInput;
...
class PaginationInputTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Finding\Types\PaginationInput', $this->obj);
    }
