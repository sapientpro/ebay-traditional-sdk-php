...
use SapientPro\EbayTraditionalSDK\Product\Types\PaginationOutput;
...
class PaginationOutputTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Product\Types\PaginationOutput', $this->obj);
    }
