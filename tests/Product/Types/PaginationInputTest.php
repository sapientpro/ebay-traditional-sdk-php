...
use SapientPro\EbayTraditionalSDK\Product\Types\PaginationInput;
...
class PaginationInputTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Product\Types\PaginationInput', $this->obj);
    }
