...
use SapientPro\EbayTraditionalSDK\Product\Types\CompatibilitySort;
...
class CompatibilitySortTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Product\Types\CompatibilitySort', $this->obj);
    }
