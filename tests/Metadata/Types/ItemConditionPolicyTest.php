...
use SapientPro\EbayTraditionalSDK\Metadata\Types\ItemConditionPolicy;
...
class ItemConditionPolicyTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Metadata\Types\ItemConditionPolicy', $this->obj);
    }
