...
use SapientPro\EbayTraditionalSDK\ReturnManagement\Types\ExtensionType;
...
class ExtensionTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ReturnManagement\Types\ExtensionType', $this->obj);
    }
