...
use SapientPro\EbayTraditionalSDK\ReturnManagement\Types\ErrorData;
...
class ErrorDataTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ReturnManagement\Types\ErrorData', $this->obj);
    }
