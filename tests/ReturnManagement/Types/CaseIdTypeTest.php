...
use SapientPro\EbayTraditionalSDK\ReturnManagement\Types\CaseIdType;
...
class CaseIdTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ReturnManagement\Types\CaseIdType', $this->obj);
    }
