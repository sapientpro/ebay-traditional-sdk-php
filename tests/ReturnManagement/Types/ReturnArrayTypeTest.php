...
use SapientPro\EbayTraditionalSDK\ReturnManagement\Types\ReturnArrayType;
...
class ReturnArrayTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ReturnManagement\Types\ReturnArrayType', $this->obj);
    }
