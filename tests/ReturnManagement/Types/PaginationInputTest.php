...
use SapientPro\EbayTraditionalSDK\ReturnManagement\Types\PaginationInput;
...
class PaginationInputTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ReturnManagement\Types\PaginationInput', $this->obj);
    }
