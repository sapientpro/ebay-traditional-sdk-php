...
use SapientPro\EbayTraditionalSDK\ReturnManagement\Types\ItemFilterType;
...
class ItemFilterTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ReturnManagement\Types\ItemFilterType', $this->obj);
    }
