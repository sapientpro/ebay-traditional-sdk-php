...
use SapientPro\EbayTraditionalSDK\ReturnManagement\Types\UserFilterType;
...
class UserFilterTypeTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\ReturnManagement\Types\UserFilterType', $this->obj);
    }
