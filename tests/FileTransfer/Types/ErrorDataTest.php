...
use SapientPro\EbayTraditionalSDK\FileTransfer\Types\ErrorData;
...
class ErrorDataTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\FileTransfer\Types\ErrorData', $this->obj);
    }
