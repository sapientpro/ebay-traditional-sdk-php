...
use SapientPro\EbayTraditionalSDK\FileTransfer\Types\ErrorMessage;
...
class ErrorMessageTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\FileTransfer\Types\ErrorMessage', $this->obj);
    }
