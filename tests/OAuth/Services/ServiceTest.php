...
namespace SapientPro\EbayTraditionalSDK\Tests\OAuth\Services;
...
use SapientPro\EbayTraditionalSDK\OAuth\Services\OAuthService;
use SapientPro\EbayTraditionalSDK\Tests\Mocks\HttpOAuthHandler;
use SapientPro\EbayTraditionalSDK\Tests\TestTraits\ManageEnv;
use Exception;
...
class ServiceTest extends TestCase
{
    ...
    public function testSandboxRedirectUrlForUser()
    {
        ...
        $url
            = 'https://auth.sandbox.ebay.com/oauth2/authorize?client_id=foo&redirect_uri=baz&response_type=code&state=111&scope=https%3A%2F%2Fapi.ebay.com%2Foauth%2Fapi_scope%2Fsell.account%20https%3A%2F%2Fapi.ebay.com%2Foauth%2Fapi_scope%2Fsell.inventory';
    ...
    public function testProductionRedirectUrlForUser()
    {
        ...
        $url
            = 'https://auth.ebay.com/oauth2/authorize?client_id=foo&redirect_uri=baz&response_type=code&state=111&scope=https%3A%2F%2Fapi.ebay.com%2Foauth%2Fapi_scope%2Fsell.account%20https%3A%2F%2Fapi.ebay.com%2Foauth%2Fapi_scope%2Fsell.inventory';
    ...
    public function testResponseIsReturned()
    {
        ...
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\OAuth\Types\GetAppTokenRestResponse', $r);
