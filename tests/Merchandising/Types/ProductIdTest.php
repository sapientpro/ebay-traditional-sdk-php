...
use SapientPro\EbayTraditionalSDK\Merchandising\Types\ProductId;
...
class ProductIdTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Merchandising\Types\ProductId', $this->obj);
    }
