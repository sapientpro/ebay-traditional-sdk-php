...
use SapientPro\EbayTraditionalSDK\Merchandising\Types\ErrorData;
...
class ErrorDataTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('\SapientPro\EbayTraditionalSDK\Merchandising\Types\ErrorData', $this->obj);
    }
