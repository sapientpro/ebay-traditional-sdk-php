...
use SapientPro\EbayTraditionalSDK\Inventory\Enums\PackageTypeEnum;
...
class PackageWeightAndSize extends BaseType
{
    ...
    private static $propertyTypes
        = [
            'dimensions'  => [
                'type'        => 'SapientPro\EbayTraditionalSDK\Inventory\Types\Dimension',
                'repeatable'  => false,
                'attribute'   => false,
            ...
            'weight'      => [
                'type'        => 'SapientPro\EbayTraditionalSDK\Inventory\Types\Weight',
                'repeatable'  => false,
                'attribute'   => false,
                'elementName' => 'weight',
            ],
