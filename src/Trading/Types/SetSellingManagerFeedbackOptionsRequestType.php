...
use SapientPro\EbayTraditionalSDK\Trading\Enums\AutomatedLeaveFeedbackEventCodeType;
...
class SetSellingManagerFeedbackOptionsRequestType extends AbstractRequestType
{
    ...
    private static $propertyTypes
        = [
            ...
            'StoredComments'              => [
                'type'        => 'SapientPro\EbayTraditionalSDK\Trading\Types\FeedbackCommentArrayType',
                'repeatable'  => false,
                'attribute'   => false,
