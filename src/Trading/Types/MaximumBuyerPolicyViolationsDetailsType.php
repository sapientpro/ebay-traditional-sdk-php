    ...
    private static $propertyTypes
        = [
            'NumberOfPolicyViolations' => [
                'type'        => 'SapientPro\EbayTraditionalSDK\Trading\Types\NumberOfPolicyViolationsDetailsType',
                'repeatable'  => false,
                'attribute'   => false,
                'elementName' => 'NumberOfPolicyViolations',
            ],
            'PolicyViolationDuration'  => [
                'type'        => 'SapientPro\EbayTraditionalSDK\Trading\Types\PolicyViolationDurationDetailsType',
                'repeatable'  => true,
                'attribute'   => false,
