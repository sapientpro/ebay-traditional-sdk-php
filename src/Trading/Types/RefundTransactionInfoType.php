...
use DateTime;
use SapientPro\EbayTraditionalSDK\Trading\Enums\PaymentTransactionStatusCodeType;
...
class RefundTransactionInfoType extends BaseType
{
    ...
    private static $propertyTypes
        = [
            ...
            'RefundTo'          => [
                'type'        => 'SapientPro\EbayTraditionalSDK\Trading\Types\UserIdentityType',
                'repeatable'  => false,
                'attribute'   => false,
            ...
            'ReferenceID'       => [
                'type'        => 'SapientPro\EbayTraditionalSDK\Trading\Types\TransactionReferenceType',
                'repeatable'  => false,
                'attribute'   => false,
