...
use SapientPro\EbayTraditionalSDK\Marketing\Enums\CriterionTypeEnum;
use SapientPro\EbayTraditionalSDK\Types\BaseType;

use function array_key_exists;

/**
 * @property bool $autoSelectFutureInventory
...
class CampaignCriterion extends BaseType
{
    ...
    private static $propertyTypes
        = [
            ...
            'selectionRules'            => [
                'type'        => 'SapientPro\EbayTraditionalSDK\Marketing\Types\SelectionRule',
                'repeatable'  => true,
                'attribute'   => false,
