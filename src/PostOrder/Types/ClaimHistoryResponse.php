...
class ClaimHistoryResponse extends BaseType
{
    ...
    private static $propertyTypes
        = [
            'history'                 => [
                'type'        => 'SapientPro\EbayTraditionalSDK\PostOrder\Types\ClaimHistoryEventModel',
                'repeatable'  => true,
                'attribute'   => false,
                'elementName' => 'history',
            ],
            'shipmentTrackingDetails' => [
                'type'        => 'SapientPro\EbayTraditionalSDK\PostOrder\Types\ShipmentTrackingDetailType',
                'repeatable'  => false,
                'attribute'   => false,
