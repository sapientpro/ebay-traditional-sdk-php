 ...
 * instance that implements SapientPro\EbayTraditionalSDK\Credentials\CredentialsInterface. If they
...
class CredentialsProvider
{
     ...
     */
    public static function defaultProvider(): callable|Closure
    {
        return self::memoize(
            self::chain(
                self::env(),
     ...
     *
     * @return callable|Closure wrapped provider that returns cached credentials when called
     */
    public static function memoize(callable $provider): callable|Closure
    {
     ...
     * @return callable|Closure
     */
    public static function chain(): callable|Closure
    {
     ...
     * @return callable
     */
    public static function env(): callable
    {
        return function () {
     ...
     *
     */
    public static function ini(string $profile = null, string $filename = null): callable
    {
