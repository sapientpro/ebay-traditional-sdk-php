...
class TreeCompiler
{
    ...
    public function visit(array $ast, $fnName, $expr)
    {
        ...
        $this->write("<?php\n")
            ->write('use SapientPro\\EbayTraditionalSDK\\JmesPath\\TreeInterpreter as Ti;')
            ->write('use SapientPro\\EbayTraditionalSDK\\JmesPath\\FnDispatcher as Fn;')
            ->write('use SapientPro\\EbayTraditionalSDK\\JmesPath\\Utils;')
            ->write('')
    ...
    private function visit_field(array $node)
    {
        ...
        $this->write('if (is_array($value) || $value instanceof \\ArrayAccess) {')
            ...
            ->outdent()
            ->write('} elseif ($value instanceof \\stdClass || $value instanceof SapientPro\\EbayTraditionalSDK\\JmesPath\\JmesPathableObjectInterface) {')
            ->indent()
