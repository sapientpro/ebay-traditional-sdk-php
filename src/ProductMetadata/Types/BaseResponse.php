...
use DateTime;
use SapientPro\EbayTraditionalSDK\ProductMetadata\Enums\AckValue;
...
class BaseResponse extends BaseType
{
    ...
    private static $propertyTypes
        = [
            ...
            'errorMessage' => [
                'type'        => 'SapientPro\EbayTraditionalSDK\ProductMetadata\Types\ErrorMessage',
                'repeatable'  => false,
                'attribute'   => false,
            ...
            'extension'    => [
                'type'        => 'SapientPro\EbayTraditionalSDK\ProductMetadata\Types\ExtensionType',
                'repeatable'  => true,
                'attribute'   => false,
