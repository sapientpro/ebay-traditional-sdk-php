...
class GetUserCasesResponse extends BaseResponse
{
    ...
    private static $propertyTypes
        = [
            'cases'            => [
                'type'        => 'SapientPro\EbayTraditionalSDK\ResolutionCaseManagement\Types\CaseArrayType',
                'repeatable'  => false,
                'attribute'   => false,
                'elementName' => 'cases',
            ],
            'paginationOutput' => [
                'type'        => 'SapientPro\EbayTraditionalSDK\ResolutionCaseManagement\Types\PaginationOutput',
                'repeatable'  => false,
                'attribute'   => false,
