...
use DateTime;
use SapientPro\EbayTraditionalSDK\ResolutionCaseManagement\Enums\AckValue;
...
class BaseResponse extends BaseType
{
    ...
    private static $propertyTypes
        = [
            ...
            'errorMessage' => [
                'type'        => 'SapientPro\EbayTraditionalSDK\ResolutionCaseManagement\Types\ErrorMessage',
                'repeatable'  => false,
                'attribute'   => false,
