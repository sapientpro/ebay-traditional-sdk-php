...
class ActivityOptionListType extends BaseType
{
    ...
    private static $propertyTypes
        = [
            'issueRefund'       => [
                'type'        => 'SapientPro\EbayTraditionalSDK\ReturnManagement\Types\IssueRefundOptionType',
                'repeatable'  => false,
                'attribute'   => false,
                'elementName' => 'issueRefund',
            ],
            'provideSellerInfo' => [
                'type'        => 'SapientPro\EbayTraditionalSDK\ReturnManagement\Types\ProvideSellerInfoOptionType',
                'repeatable'  => false,
                'attribute'   => false,
